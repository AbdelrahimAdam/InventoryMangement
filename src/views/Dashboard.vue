<template>
  <div :class="['min-h-screen transition-colors duration-200', isDarkMode ? 'bg-gray-900' : 'bg-yellow-50']">
    ...
    <header class="sticky top-0 z-50 bg-white dark:bg-gray-800 shadow-md border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
      <div class="max-w-full xl:max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-1">
              ...
              >
                <div class="flex items-center">
                  <div class="h-5 w-5 rounded-md bg-yellow-100 dark:bg-yellow-900 flex items-center justify-center ml-2">
      ...
      <div class="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-gray-800 dark:to-gray-900 border-t border-yellow-100 dark:border-gray-700">
        <div class="max-w-full xl:max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
          <div class="flex flex-col sm:flex-row items-center justify-between gap-2">
            ...
            <div class="flex space-x-2 space-x-reverse flex-wrap justify-center sm:justify-start">
    ...
    <div class="max-w-full xl:max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div v-else class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 transition-colors duration-200 hover:shadow-md">
                <div class="px-4 py-5 sm:p-6">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 h-12 w-12 rounded-lg bg-yellow-100 dark:bg-yellow-900 flex items-center justify-center">
                    ...
                    <div class="mr-4">
                      <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">إجمالي الأصناف</dt>
                      <dd class="mt-1 text-2xl font-semibold text-gray-900 dark:text-white">{{ dashboardStats.totalItems }}</dd>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 transition-colors duration-200 hover:shadow-md">
                <div class="px-4 py-5 sm:p-6">
                  <div class="flex items-center">
                    ...
                    <div class="mr-4">
                      <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">إجمالي الكمية</dt>
                      <dd class="mt-1 text-2xl font-semibold text-gray-900 dark:text-white">{{ formatNumber(dashboardStats.totalQuantity) }}</dd>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 transition-colors duration-200 hover:shadow-md">
                <div class="px-4 py-5 sm:p-6">
                  <div class="flex items-center">
                    ...
                    <div class="mr-4">
                      <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">أصناف قليلة</dt>
                      <dd class="mt-1 text-2xl font-semibold text-red-600 dark:text-red-400">{{ dashboardStats.lowStockItems }}</dd>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 transition-colors duration-200 hover:shadow-md">
                <div class="px-4 py-5 sm:p-6">
                  <div class="flex items-center">
                    ...
                    <div class="mr-4">
                      <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">الحركات اليوم</dt>
                      <dd class="mt-1 text-2xl font-semibold text-gray-900 dark:text-white">{{ dashboardStats.recentTransactions }}</dd>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div>
                  <h2 class="text-xl font-bold text-gray-900 dark:text-white">المخزون الحالي</h2>
                  <p class="text-sm text-gray-500 dark:text-gray-400">عرض جميع الأصناف في النظام</p>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                  ...
                  <div class="relative flex-grow">
                    ...
                    <input
                      ...
                      class="block w-full pr-10 pl-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-colors duration-200"
                    />
                  </div>
                  ...
                  <select
                    ...
                    class="block w-full sm:w-auto pl-3 pr-10 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition-colors duration-200"
                  ...
                  <!-- Add Item Button (FIXED: This is the missing button) -->
                  <button 
                    v-if="canModifyItems"
                    @click="openAddItemModal"
                    class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-medium rounded-lg hover:from-yellow-600 hover:to-orange-600 transition-all duration-200 shadow-md hover:shadow-lg"
                  >
                    <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                    </svg>
              ...
              <InventoryTable 
                v-else-if="transformedInventory.length > 0"
              ...
              <!-- Pagination Info -->
              <div v-if="transformedInventory.length > 0" class="mt-4 text-sm text-gray-700 dark:text-gray-400">
              ...
              <div v-else-if="!loading" class="text-center py-12">
                ...
                <button 
                  v-if="canModifyItems" 
                  @click="openAddItemModal" 
                  class="mt-4 inline-flex items-center px-4 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-medium rounded-lg hover:from-yellow-600 hover:to-orange-600 transition-colors duration-200 shadow-md"
                >
                  إضافة صنف جديد
                </button>
              </div>
    ...
    <div class="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 z-40">
      <div class="flex justify-around p-2">
        ...
        <button 
          v-if="canModifyItems"
          @click="openAddItemModal" 
          class="flex flex-col items-center p-2 text-yellow-600 dark:text-yellow-400"
        >
          <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
          </svg>
