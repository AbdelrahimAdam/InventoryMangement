    ...
    <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
      ...
      <div v-else class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="hidden lg:block">
          ...
          <div v-if="!hasMore && filteredItems.length > 0" class="p-4 text-center text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700">
        ...
        <div class="lg:hidden">
          ...
          <div v-else class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div v-if="hasMore && !isFetchingMore" class="p-4 text-center">
              <button
                @click="loadMoreItems"
                :disabled="inventoryLoading || isFetchingMore"
